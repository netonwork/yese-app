  ...
  return (
    <Layout>
      ...
      <header className="flex items-center justify-between p-4">
        ...
        <h1 className="text-lg font-semibold text-white">重置密码</h1>
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">请输入手机号和验证码来重置您的密码</p>
          </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={countdown > 0 || sendingCode || !formData.phone}
                  className="px-4 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl font-medium hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 whitespace-nowrap"
                >
